...
contract Reputationcalculation  {
    ...
    function DirectReputation( address edgeserver,address mobileuser,int256 Eus )public { 
   ...
   SD59x18 SDdiv=(SD59x18.wrap(SDSub)).div( wrap(numRatings));
    ...
    resultDirection=[REus,DRus,resultf,wrap(t),wrap(T),wrap(SIC)];
